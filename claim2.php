...
<html lang="en">
	<head>
		<meta charset="utf-8">
		<title>Pre - pre-sell while you make</title>
...
<!--					<section class="left-section app wow " data-wow-delay="0.1s"></section>-->
					...
					<section class="right-section">
						<div class="arrow"><i class="fa fa-chevron-down" aria-hidden="true"></i></div>
						<div class="main-logo">
							<a href="#"><img class="item-image wow " src="" width="188" height="188" alt="Logo" style="border:0px solid #ccc; background:#fff; padding:10px" /></a>
						</div>

						<div class="intro intro-app">
							<div class="intro-text">
								<p>1. Invite 3 friends to <a href="http://me.me/gamebotsc" target="_blank">m.me/gamebotsc</a> &amp; <a href="http://kik.me/game.bots" target="_blank">kik.me/game.bots</a></p>
								...
								<p>3. Give Gamebots 5 stars on <a href="http://me.me/gamebotsc" target="_blank">m.me/gamebotsc</a> &amp; <a href="http://kik.me/game.bots" target="_blank">kik.me/game.bots</a></p>
								<p>4. Submit trade with security code: <span class="pin-code"></span>-<span class="item-name"></span></p>
								<p>5. Trade URL: <span class="trade-url"></span></p>
							</div>
